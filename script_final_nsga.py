...
from genetic_algorithm_nsga import GeneticAlgorithmNSGA
...
if __name__ == "__main__":
    ...
    best_weights = ga.run(population_size=50, num_generations=200, save_interval=4)
    ...
    model_file = "experiments/model_hybrid_ga_nsga_gen100_acc99.pt"
